...
from ast import literal_eval  # <--- NEW IMPORT
...
def preprocess_df(df):
    """
    Optimizes the dataframe by converting string representations of lists 
    into actual python lists once at the beginning.
    """
    print("Preprocessing dataframe (parsing RLE strings)...")
...
def main():
    ...
    # --- OPTIMIZATION STEP ---
    # Convert strings to lists ONCE here so Dataset doesn't do it 1000x times
